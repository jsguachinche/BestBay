...
function collapseTV() {
  ...
  <div id="accordion" role="tablist" aria-multiselectable="true">
      ...
      <div class="card">
          ...
          <div id="collapseFourth" class="collapse" role="tabpanel" aria-labelledby="headingFourth">
              <div class="card-block">
                  <p><input type="checkbox" name="tvColor" value="Blanco"> Blanco</p>
                  <p><input type="checkbox" name="tvColor" value="Gris"> Gris</p>
                  <p><input type="checkbox" name="tvColor" value="Negro"> Negro</p>
                  <p><input type="checkbox" name="tvColor" value="Rojo"> Rojo</p>
              </div>
          </div>
      </div>
      <div class="card">
